...
use cpython::{PyResult, ToPyObject, PyDict, Python};
...
impl ToPyObject for report::Report {
    ...
    fn to_py_object(&self, py: Python) -> PyDict {
        ...
        dict.set_item(py, "report_host", &self.report_hosts).unwrap();
        dict
    }
}
...
impl ToPyObject for report::ReportHost {
    ...
    fn to_py_object(&self, py: Python) -> PyDict {
        ...
        dict.set_item(py, "host_properties", &self.host_properties).unwrap();
        dict.set_item(py, "report_items", &self.report_items).unwrap();
        dict
    }
}
...
impl ToPyObject for report::ReportItem {
    ...
    fn to_py_object(&self, py: Python) -> PyDict {
        ...
        dict.set_item(py, "service_name", &self.service_name).unwrap();
        ...
        dict.set_item(py, "exploit_available", &self.exploit_available).unwrap();
        dict.set_item(py, "exploitability_ease", &self.exploitability_ease).unwrap();
        dict.set_item(py, "osvdb", &self.osvdb).unwrap();
        dict.set_item(py, "cve", &self.cve).unwrap();
        dict.set_item(py, "cvss3_base_score", &self.cvss3_base_score).unwrap();
        dict.set_item(py, "cvss_base_score", &self.cvss_base_score).unwrap();
        ...
        dict.set_item(py, "plugin_output", &self.plugin_output).unwrap();
        dict.set_item(py, "nessus_script", &self.nessus_script).unwrap();
        dict.set_item(py, "exploited_by_nessus", &self.exploited_by_nessus).unwrap();
        dict.set_item(py, "metasploit", &self.exploit_framework_metasploit).unwrap();
        dict.set_item(py, "metasploit_name", &self.metasploit_name).unwrap();
        dict.set_item(py, "canvas", &self.exploit_framework_canvas).unwrap();
        dict.set_item(py, "canvas_package", &self.canvas_package).unwrap();
        dict.set_item(py, "core", &self.exploit_framework_core).unwrap();
        ...
        dict.set_item(py, "patch_publication_date", &self.patch_publication_date).unwrap();
        dict.set_item(py, "vuln_publication_date", &self.vuln_publication_date).unwrap();
        dict
    }
}
